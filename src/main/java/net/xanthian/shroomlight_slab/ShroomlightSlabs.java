...
public class ShroomlightSlabs implements ModInitializer {
    ...
    public static final Block SHROOMLIGHT_SLAB = Registry.register(Registry.BLOCK, namespace, new SlabBlock(FabricBlockSettings.of(Material.NETHER_SHOOTS).strength(1.0F, 1.0F)));
