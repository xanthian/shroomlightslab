...
public class ShroomlightSlabs implements ModInitializer {
    ...
    public static final Block SHROOMLIGHT_SLAB = Registry.register(Registry.BLOCK, namespace, new SlabBlock(AbstractBlock.Settings.copy(SHROOMLIGHT).strength(0.2f)));
